...
import 'sanguine_model.dart';
export 'sanguine_model.dart';

class SanguineWidget extends StatefulWidget {
  const SanguineWidget({Key? key}) : super(key: key);

  @override
  _SanguineWidgetState createState() => _SanguineWidgetState();
}

class _SanguineWidgetState extends State<SanguineWidget> {
  late SanguineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SanguineModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Sanguine'});
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            backgroundColor: Color(0xFFF4D428),
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SANGUINE_arrow_back_rounded_ICN_ON_TAP');
