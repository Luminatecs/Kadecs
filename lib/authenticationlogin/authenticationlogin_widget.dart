...
import 'authenticationlogin_model.dart';
export 'authenticationlogin_model.dart';
...
class _AuthenticationloginWidgetState extends State<AuthenticationloginWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'authenticationlogin'});
                                  ...
                                  if (responsiveVisibility(
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'AUTHENTICATIONLOGIN_arrow_back_rounded_I');
                                          logFirebaseEvent(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'AUTHENTICATIONLOGIN_LOG_IN_BTN_ON_TAP');
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'AUTHENTICATIONLOGIN_CONTINUE_WITH_GOOGLE');
                                        logFirebaseEvent('Button_auth');
                                        GoRouter.of(context).prepareAuthEvent();
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'AUTHENTICATIONLOGIN_RichText_rsswap9a_ON');
                                        logFirebaseEvent(
